...
public:
	...
	addr_t GBFilter_start_addr = 0x74000000;
 	addr_t GBFilter_size = 0x01000000;
	addr_t GBFilter_end_addr = GBFilter_start_addr + GBFilter_size - 1;
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[13] = new PortMapping(opt.GBFilter_start_addr, opt.GBFilter_end_addr);
	...
	bus.isocks[13].bind(GB_filter.tsock);
